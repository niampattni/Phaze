...
/**
 * The LevelOne class is a JPanel which is reposncible for setting up the game
 * aspects which are unique to Level 1 as well as using PictureExplorer to colour
...
public class LevelOne extends JPanel {
  ...
  public LevelOne() {
    ...
    try {
      ...
      bImg = ImageIO.read(this.getClass().getResource("images\\Level1BG.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }
