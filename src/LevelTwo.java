...
/**
 * The LevelTwo class is a JPanel which is reposncible for setting up the game
 * aspects which are unique to Level 2 as well as using PictureExplorer to colour
...
public class LevelTwo extends JPanel {
  ...
  public LevelTwo() {
    ...
    try {
      ...
      bImg = ImageIO.read(this.getClass().getResource("images\\Level2BG.png"));
    } catch (IOException e) {
      e.printStackTrace();
    }
